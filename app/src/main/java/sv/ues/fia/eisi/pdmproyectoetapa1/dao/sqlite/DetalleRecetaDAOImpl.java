...
import sv.ues.fia.eisi.pdmproyectoetapa1.dao.sqlite.FarmaciaContrato.EntradaDetalleReceta;
...
public class DetalleRecetaDAOImpl implements DetalleRecetaDAO {
    ...
    private static ContentValues getContentValues(DetalleReceta obj){
        ...
        valores.put(EntradaDetalleReceta.PERIODICIDAD, obj.getPeriodicidad());
        valores.put(EntradaDetalleReceta.DOSIS, obj.getDosis());
        valores.put(EntradaDetalleReceta.FECHA_INICIO_TRATAMIENTO, obj.getFechaInicioTratamiento());
        valores.put(EntradaDetalleReceta.FECHA_FIN_TRATAMIENTO, obj.getFechaFinTratamiento());
        valores.put(EntradaDetalleReceta.ID_RECETA_MEDICA, obj.getIdRecetaMedica());
        valores.put(EntradaDetalleReceta.ID_MEDICAMENTO, obj.getIdMedicamento());
        return valores;
    }
    ...
    private static ContentValues getContentValues(DetalleReceta obj, String idDetalleReceta){
        ContentValues valores = new ContentValues();
        valores.put(EntradaDetalleReceta.ID_DETALLE_RECETA, idDetalleReceta);
        valores.put(EntradaDetalleReceta.PERIODICIDAD, obj.getPeriodicidad());
        valores.put(EntradaDetalleReceta.DOSIS, obj.getDosis());
        valores.put(EntradaDetalleReceta.FECHA_INICIO_TRATAMIENTO, obj.getFechaInicioTratamiento());
        valores.put(EntradaDetalleReceta.FECHA_FIN_TRATAMIENTO, obj.getFechaFinTratamiento());
    ...
    public void modificar(DetalleReceta obj) throws DAOException {
        ...
        db.update(Tablas.DETALLE_RECETA, valores, EntradaDetalleReceta.ID_DETALLE_RECETA + "=?", idDetalleReceta);
    }
    ...
    public void eliminar(DetalleReceta obj) throws DAOException {
        ...
        String whereClause = String.format("%s=?", EntradaDetalleReceta.ID_DETALLE_RECETA);
        String[] idDetalleReceta = {obj.getIdDetalleReceta()};

        //Eliminar Detalle Receta
        db.delete(Tablas.DETALLE_RECETA, EntradaDetalleReceta.ID_DETALLE_RECETA + "=?", idDetalleReceta);
    }
    ...
    public List<DetalleReceta> obtenerTodos() throws DAOException {
        ...
        try(Cursor cursor = db.rawQuery(sql, null)){
            ...
            do{
                ...
                int idIndex = cursor.getColumnIndex(EntradaDetalleReceta.ID_DETALLE_RECETA);
                int periodicidadIndex = cursor.getColumnIndex(EntradaDetalleReceta.PERIODICIDAD);
                int dosisIndex = cursor.getColumnIndex(EntradaDetalleReceta.DOSIS);
                int fechaInicioTratamientoIndex = cursor.getColumnIndex(EntradaDetalleReceta.FECHA_INICIO_TRATAMIENTO);
                int fechaFinTratamientoIndex = cursor.getColumnIndex(EntradaDetalleReceta.FECHA_FIN_TRATAMIENTO);
                int idRecetaMedicaIndex = cursor.getColumnIndex(EntradaDetalleReceta.ID_RECETA_MEDICA);
                int idMedicamentoIndex = cursor.getColumnIndex(EntradaDetalleReceta.ID_MEDICAMENTO);
    ...
    public DetalleReceta obtener(String id) throws DAOException {
        SQLiteDatabase db = baseDatos.getReadableDatabase();
        String selection = String.format("%s=?", EntradaDetalleReceta.ID_DETALLE_RECETA);
    ...
    public DetalleReceta obtenerDetallePorIdReceta(String idRecetaMedica) throws DAOException {
        SQLiteDatabase db = baseDatos.getReadableDatabase();
        String selection = String.format("%s=?", EntradaDetalleReceta.ID_RECETA_MEDICA);
