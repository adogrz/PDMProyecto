...
public class MedicoDAOImpl implements MedicoDAO {
    ...
    private boolean verificarIntegridad(Medico medico, int operacion) {
        ...
        Cursor cursorMedico = db.query(Tablas.MEDICO,
                null, FarmaciaContrato.EntradaMedico.ID_MEDICO + "=?",
    ...
    private static ContentValues getContentValues(Medico obj){
        ...
        valores.put(FarmaciaContrato.EntradaMedico.NOMBRE_MEDICO, obj.getNombreMedico());
        valores.put(FarmaciaContrato.EntradaMedico.APELLIDO_MEDICO, obj.getApellidoMedico());
        valores.put(FarmaciaContrato.EntradaMedico.ESPECIALIDAD, obj.getEspecialidad());
        valores.put(FarmaciaContrato.EntradaMedico.JVPM, obj.getJvpm());
        return valores;
    }
    ...
    private static ContentValues getContentValues(Medico obj, String idMedico){
        ContentValues valores = new ContentValues();
        valores.put(FarmaciaContrato.EntradaMedico.ID_MEDICO, idMedico);
        valores.put(FarmaciaContrato.EntradaMedico.NOMBRE_MEDICO, obj.getNombreMedico());
        valores.put(FarmaciaContrato.EntradaMedico.APELLIDO_MEDICO, obj.getApellidoMedico());
        valores.put(FarmaciaContrato.EntradaMedico.ESPECIALIDAD, obj.getEspecialidad());
        valores.put(FarmaciaContrato.EntradaMedico.JVPM, obj.getJvpm());
    ...
    public void modificar(Medico obj) throws DAOException {
        ...
        //modificar medico
        db.update(Tablas.MEDICO, valores, FarmaciaContrato.EntradaMedico.ID_MEDICO + "=?", idMedico);
    }
    ...
    public void eliminar(Medico obj) throws DAOException {
        ...
        SQLiteDatabase db = baseDatos.getWritableDatabase();
        String whereClause = String.format("%s=?", FarmaciaContrato.EntradaMedico.ID_MEDICO);
        String[] idMedico = {obj.getIdMedico()};

        //eliminar medico
        db.delete(Tablas.MEDICO, FarmaciaContrato.EntradaMedico.ID_MEDICO + "=?", idMedico);
    }
    ...
    public List<Medico> obtenerTodos() throws DAOException {
        ...
        try(Cursor cursor = db.rawQuery(sql, null)){
            ...
            do{
                ...
                int idIndex = cursor.getColumnIndex(FarmaciaContrato.EntradaMedico.ID_MEDICO);
                int nombreMedicoIndex = cursor.getColumnIndex(FarmaciaContrato.EntradaMedico.NOMBRE_MEDICO);
                int apellidoMedicoIndex = cursor.getColumnIndex(FarmaciaContrato.EntradaMedico.APELLIDO_MEDICO);
                int especialidadIndex = cursor.getColumnIndex(FarmaciaContrato.EntradaMedico.ESPECIALIDAD);
                int jvpmIndex = cursor.getColumnIndex(FarmaciaContrato.EntradaMedico.JVPM);
    ...
    public Medico obtener(String id) throws DAOException {
        SQLiteDatabase db = baseDatos.getReadableDatabase();
        String selection = String.format("%s=?", FarmaciaContrato.EntradaMedico.ID_MEDICO);
